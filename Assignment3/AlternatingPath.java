...
public class AlternatingPath {
    ...
    public static void main(String[] args) {
        ...
        AlternatingPath a = new AlternatingPath(edges, "A", "E");
        System.out.println(a.findAlternatingPath());
        AlternatingPath b = new AlternatingPath(edges, "E", "D");
    ...
    public AlternatingPath(ArrayList<Edge> edges, String origin, String destination) {
